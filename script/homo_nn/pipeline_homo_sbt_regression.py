#  python /main/script/homo_nn/pipeline_homo_sbt_regression.py -config /main/script/homo_nn/config.yaml
...
def main(config="../../config.yaml", namespace=""):
    ...
    guest_train_data = {"name": "nasa_A_guest", "namespace": f"experiment"}
    guest_validate_data = {"name": "nasa_A_test", "namespace": f"experiment"}

    host_train_data = {"name": "nasa_B_host", "namespace": f"experiment"}
    host_validate_data = {"name": "nasa_B_test", "namespace": f"experiment"}
