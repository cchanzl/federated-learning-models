#  python /main/script/pipeline-upload-class.py --base /main/data
...
def main(data_base=DATA_BASE):
    ...
    party_A_train = "party_A_train_class.csv"
    party_B_train = "party_B_train_class.csv"
    party_C_train = "party_C_train_class.csv"

    party_A_train_name = "nasa_A"
    party_B_train_name = "nasa_B"
    party_C_train_name = "nasa_C"

    party_A_test = "party_A_test_class.csv"
    party_B_test = "party_B_test_class.csv"
    party_C_test = "party_C_test_class.csv"
